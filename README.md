...
The current public release is `1.4.2`, maintained by Mainul Hasan. Update `site-meta.js` whenever a release is published, then add the matching entry to `updates.html` so students can see what changed.
